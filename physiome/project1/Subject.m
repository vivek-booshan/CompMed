classdef Subject
    ...
    methods
        ...
        function [...
            ...
            % find idx and get desired slice for time and abp        
            ...
            % get offsets using beatperiod using filter and trim
        ...
        function [calibrateCO, k_parli, Rn, true_Rn, k_Rn] = Parlikar(obj, alpha, window_size)
            ...
            %   - k_parli (double) : scale factor
            %   - R_n (nx1 double) : TPR estimates
